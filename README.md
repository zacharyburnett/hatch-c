...
[![build](https://github.com/zacharyburnett/hatch-c/actions/workflows/build.yml/badge.svg?branch=main&event=release)](https://github.com/zacharyburnett/hatch-c/actions/workflows/build.yml)
